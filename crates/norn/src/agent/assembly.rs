...
/// [`apply_skill_listing`](crate::agent::arming::apply_skill_listing) — the
/// single shared mechanism every launch path
...
/// [`arm_auto_compaction`](crate::agent::arming::arm_auto_compaction), which
/// the caller invokes once the effective
