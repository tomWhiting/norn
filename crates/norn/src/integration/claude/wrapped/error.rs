//! Typed configuration, protocol and lifecycle failures for wrapped Claude.
...
pub enum NornWrappedClaudeError {
    ...
    /// The requested effort is absent from the Claude Code effort vocabulary.
    #[error(
        "reasoning effort '{effort}' is not supported by Claude Code; omit reasoning_effort to use its default"
    )]
    UnsupportedReasoningEffort {
        /// The exact unsupported Norn effort identifier.
        effort: &'static str,
    },
