...
pub struct AppState {
    ...
    pub(in crate::app) agent_conversations: super::agent_conversations::AgentConversations,
...
impl AppState {
    ...
    pub fn new(
        ...
        Self {
            ...
            agent_conversations: super::agent_conversations::AgentConversations::default(),
