...
|---|---|---|
| `GD-1` | `3d5ff8c` and `0e8fb49`; private `settings.local.json` provenance in config/runtime fixtures, including `workspace_local_server_is_direct_and_not_approval_gated`. | Implemented; Gate C pass. |
