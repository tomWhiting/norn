...
SENTINEL_TESTS: Final = (
    ...
    "tools::agent::fork_seed::tests::legacy_response_group_fork_deliberately_enriches_only_boundary_metadata",
    ...
    "session::response_publication_commitment_tests::complete_legacy_uncommitted_group_remains_readable",
    "session::response_publication_commitment_tests::structurally_decodable_invalid_commitments_fail_validation",
    "session::response_publication_commitment_tests::unknown_response_publication_v2_reason_fails_closed",
    "session::response_publication_commitment_tests::durable_committed_prefix_completes_on_exact_retry",
    "session::response_publication_commitment_tests::durable_committed_prefix_rejects_divergent_unwritten_suffix",
    "session::response_publication_commitment_tests::durable_boundary_rejects_a_recomputed_divergent_commitment",
    "session::response_publication_commitment_tests::durable_legacy_prefix_cannot_be_completed",
    "session::persistence::strict::validation_tests::rejects_a_canonical_timeline_with_a_tampered_publication_commitment",
