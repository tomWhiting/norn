> Integration status, 6 September 2026, Melbourne: this preserved candidate is being reconciled under [NSP-001](design/norn-claude-parity/briefs/NSP-001.md) onto `d27259cc1c218a44be0ce624d103b04d799dcf21` in `codex/norn-claude-parity-integrated`. The text below records the25 July source state; its paths, gate claims and compatibility labels are historical. No current acceptance or release is claimed here.
